...
String getNumericFormField(String attributeName, JsonWidgetRegistry registry, Map<String, dynamic> conformanceOverlay){
  String textFormFieldJson = '';
  if(parseConformanceOverlay(conformanceOverlay, attributeName) == true){
    textFormFieldJson = '{"type":"column", "children": [{"type": "text","args": {"text":"\${returnLabel(\'$attributeName\', language ?? currentLanguage)}"}},{"type":"padding","args":{"padding":"\${scaleSize(25)}"}, "children":[{"type": "text_form_field","id": "edit${toBeginningOfSentenceCase(attributeName)}", "args":{"decoration":{"border": {"type":"outline","width":2}}, "keyboardType":"number", "validators": [{"type": "required"},{"type":"regex","regex":"[+-]?([0-9]*[.])?[0-9]+"}]}}]}, {"type": "text","args": {"text":"\${returnLabel(\'information-$attributeName\', language ?? currentLanguage)}","style": {"fontSize": "\${scaleSize(25)}","color": "#737170"}}}]}';
  }else{
...
String parseMetaOverlay(List<dynamic> metaOverlay, JsonWidgetRegistry registry){
  ...
  String textFormTitleJson = '{"type" : "column","children" : [{"type" : "text","args": {"text" : "\${returnLabel(\'formTitle\', language ?? currentLanguage)}", "style": {"fontSize": "\${scaleSize(65)}","color": "#000000","fontWeight" : "bold"}}},{"type" : "container","args": {"width": "\${scaleSize(325)}","height": "\${scaleSize(180)}"},"children" : [{"type" : "set_value","children" : [{"type": "dropdown_button_form_field","id": "language","args": {"decoration":{"border": {"type":"outline","width":2}},"style": {"fontSize": "\${scaleSize(20)", "color":"#000000"},"value" : "\${returnLanguages()[0]}","items": "\${returnLanguages()}"}}]} ]}]}';
